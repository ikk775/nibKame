...
\end{equation}
は，$P$と$P \limpl Q$という仮定から，\rulename{M.P.}という推論規則によって$Q$が導き出されることを表す記法である.
...
\section{バッカス・ナウア記法について}\label{sec:about-BNF-form}
...
\section{ラムダ式について}\label{sec:about-lambda-expression}
