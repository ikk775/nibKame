...
\newcommand{\responsibility}[1]{\par\begin{flushright}[文責: #1]\end{flushright}}
...
\newmonadicopdot{\fixdot}{\mathnkop{fix}}
...
\newcommand{\domainrestrict}[2]{#1\mathop{\upharpoonright}#2}
\newcommand{\freevars}[1]{\mathit{FV}(#1)}
\newcommand{\freetypevars}[1]{\mathit{FTV}(#1)}
\newcommand{\freevarsp}[1]{\mathit{FV}_p(#1)}
